 ...
 *
 * Q1: Once upon a time, the polymath Ismail al-Jazari was unraveling the mysteries of the universe
 *     when, suddenly, Luka Zaridze saved the Leshan Giant Buddha from kleptomaniacal aliens
 *     by setting up an elaborate diversion. THE END!
 *
 * Q2: On Windows 10, clicking the stack overflow button made the program freeze for 2 seconds,
 *     then showed a "Program.exe has stopped working" dialog with a sad face icon. The Qt Creator
 *     output pane displayed: "The program has unexpectedly finished. Exit code 0xC00000FD
 *     (STATUS_STACK_OVERFLOW)". The window turned white and became unresponsive.
 *
 * Q3: The cycle of recursive calls was: 724, 158, 963, 415, 724
 *
 */
 ...
 */
const string MyName = "Luka Zaridze";
